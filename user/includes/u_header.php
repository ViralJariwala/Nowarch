...
<!-- Mirrored from duruthemes.com/demo/html/nowarch/multipage-dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Mar 2022 13:37:39 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <title>NOWARCH - ARCHITECTURE</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="logo-wrapper navbar-brand valign">
                <a class="logo" href="index.php"> 
                    ...
                    <h2>NOWARCH<span>Architecture</span></h2>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                   ...
                   <i class="ti-angle-down"></i></span>
                        <ul class="dropdown-menu last">
                            <li class="dropdown-item"><a href="/arch/logout.php">Logout</a></li>
    ...
    <header class="header slider-fade">
        <div class="owl-carousel owl-theme">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="o-hidden">
                                    ...
                                    <div class="butn-dark mt-30 mb-30"><a href="projects.php"><span>See project <i class="ti-arrow-right"></i></span></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="item bg-img" data-overlay-dark="3" data-background="img/slider/2.jpg">
                <div class="v-middle caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center">
            ...
            <div class="item bg-img" data-overlay-dark="3" data-background="img/slider/3.jpg">
                <div class="v-middle caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center">
        ...
        <div class="social-icon"> 
            ...
            <a href="#0"><i class="ti-twitter"></i></a> 
